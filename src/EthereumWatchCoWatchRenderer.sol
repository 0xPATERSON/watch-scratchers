...
contract EthereumWatchCoWatchRenderer is Ownable, IEthereumWatchCoWatchRenderer {
    ...
    function _renderPP(
        ...
        if (watchType == IEthereumWatchCoWatchRenderer.WatchType.PP_TIFFANY || watchType == IEthereumWatchCoWatchRenderer.WatchType.PP_WHITE) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1900 1900', '157.7', '310.8', '#041418', '#041418', '#FEFEFD', IEthereumWatchCoWatchHandsRenderer.HandType.ROUND);
            ...
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1900 1900', '157.7', '310.8', '#B4B8B2', '#B4B8B2', '#FEFEFD', IEthereumWatchCoWatchHandsRenderer.HandType.ROUND); 
        } else if (watchType == IEthereumWatchCoWatchRenderer.WatchType.PP_CHOCOLATE) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1900 1900', '157.7', '310.8', '#EFCCAC', '#EFCCAC', '#FEFEFD', IEthereumWatchCoWatchHandsRenderer.HandType.ROUND);
        }
    ...
    function _renderVC(
        ...
        if (watchType == IEthereumWatchCoWatchRenderer.WatchType.VC_BLUE || watchType == IEthereumWatchCoWatchRenderer.WatchType.VC_BLACK) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1800 1800', '157.1', '309.2', '#C9C5C8', '#C9C5C8', '#FFFCFB', IEthereumWatchCoWatchHandsRenderer.HandType.ROUND);
        } else if (watchType == IEthereumWatchCoWatchRenderer.WatchType.VC_WHITE) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1800 1800', '157.1', '309.2', '#3E3C3A', '#3E3C3A', '#FFFCFB', IEthereumWatchCoWatchHandsRenderer.HandType.ROUND); 
        } else if (watchType == IEthereumWatchCoWatchRenderer.WatchType.VC_BLUE_RG) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1800 1800', '157.1', '309.2', '#EBB788', '#EBB788', '#FFFCFB', IEthereumWatchCoWatchHandsRenderer.HandType.ROUND);
        }
        return string(abi.encodePacked(caseSvgStart, coloredWatchCase, caseSvgEnd, watchHands));
    }
    ...
    function _renderSUB(
        ...
        if (watchType == IEthereumWatchCoWatchRenderer.WatchType.SUB_BLACK_TT || watchType == IEthereumWatchCoWatchRenderer.WatchType.SUB_BLUE_TT || watchType == IEthereumWatchCoWatchRenderer.WatchType.SUB_BLACK_YG || watchType == IEthereumWatchCoWatchRenderer.WatchType.SUB_BLUE_YG) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1700 1700', '156.3', '308.9', '#FBECC8', '#FBECC8', '#F6F8F7', IEthereumWatchCoWatchHandsRenderer.HandType.SPORT);
        } else {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1700 1700', '156.3', '308.9', '#C1C1C1', '#C1C1C1', '#F6F8F7', IEthereumWatchCoWatchHandsRenderer.HandType.SPORT);
        }
        return string(abi.encodePacked(caseSvgStart, coloredWatchCase, caseSvgEnd, watchHands));
    }
    ...
    function _renderYACHT(
        ...
        if (watchType == IEthereumWatchCoWatchRenderer.WatchType.YACHT_BLUE) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1700 1700', '156.3', '308.9', '#FA0029', '#C1C1C1', '#F6F8F7', IEthereumWatchCoWatchHandsRenderer.HandType.SPORT);
        } else {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1700 1700', '156.3', '308.9', '#00ABD9', '#C1C1C1', '#F6F8F7', IEthereumWatchCoWatchHandsRenderer.HandType.SPORT);
        }
        return string(abi.encodePacked(caseSvgStart, coloredWatchCase, caseSvgEnd, watchHands));
    }
    ...
    function _renderOpDjExp(
        ...
        if (watchType >= IEthereumWatchCoWatchRenderer.WatchType.OP_YELLOW && watchType < IEthereumWatchCoWatchRenderer.WatchType.DJ_WHITE) {
            ...
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1750 1750', '156.5', '308.9', '#E4E4E4', '#E4E4E4', '#F7FDFA', IEthereumWatchCoWatchHandsRenderer.HandType.DRESS_ROLEX);
            ...
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1750 1750', '156.5', '308.9', '#E4E4E4', '#E4E4E4', '#F7FDFA', IEthereumWatchCoWatchHandsRenderer.HandType.SPORT);
        }
        string memory coloredWatchCase = _colorReplace(watchCase, watchType);
    ...
    function _renderAQ(
        ...
        if (watchType == IEthereumWatchCoWatchRenderer.WatchType.AQ_WHITE) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1630 1630', '155.7', '308.4', '#F96C00', '#525353', '#FFFFFF', IEthereumWatchCoWatchHandsRenderer.HandType.SPORT);
        } else if (watchType == IEthereumWatchCoWatchRenderer.WatchType.AQ_GREY) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1630 1630', '155.7', '308.4', '#00588B', '#00588B', '#FFFFFF', IEthereumWatchCoWatchHandsRenderer.HandType.SPORT);
        } else {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1630 1630', '155.7', '308.4', '#DDDDDD', '#B6B6B6', '#FFFFFF', IEthereumWatchCoWatchHandsRenderer.HandType.DRESS);
        }
        return string(abi.encodePacked(caseSvgStart, coloredWatchCase, caseSvgEnd, watchHands));
    }
    ...
    function _renderPILOT(
        ...
        if (watchType == IEthereumWatchCoWatchRenderer.WatchType.PILOT_WHITE) {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1650 1650', '155.7', '308.5', '#0E0E0E', '#0E0E0E', '#FFFFFF', IEthereumWatchCoWatchHandsRenderer.HandType.SPORT);
        } else {
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1650 1650', '155.7', '308.5', '#FFFFFF', '#444444', '#FFFFFF', IEthereumWatchCoWatchHandsRenderer.HandType.DRESS);
        }
        return string(abi.encodePacked(caseSvgStart, coloredWatchCase, caseSvgEnd, watchHands));
    }
    ...
    function _renderTANK(
        ...
        if (watchType >= IEthereumWatchCoWatchRenderer.WatchType.TANK && watchType < IEthereumWatchCoWatchRenderer.WatchType.TANK_F) {
            ...
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 2500 2500', '159.3', '312.4', '#1C55B4', '#1C55B4', '#1C55B4', IEthereumWatchCoWatchHandsRenderer.HandType.TANK);
        } else {
            ...
            watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 2500 2500', '159.6', '311.7', '#1C55B4', '#1C55B4', '#1C55B4', IEthereumWatchCoWatchHandsRenderer.HandType.TANK_F);
        }
        string memory coloredWatchCase = _colorReplace(watchCase, watchType);
    ...
    function _renderGS() public view returns (string memory) { 
        ...
        string memory watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1630 1630', '155.5', '308.7', '#006AB4', '#B1B0AF', '#B1B0AF', IEthereumWatchCoWatchHandsRenderer.HandType.DRESS);
    ...
    function _renderSENATOR() public view returns (string memory) { 
        ...
        string memory watchHands = IEthereumWatchCoWatchHandsRenderer(watchHandsRenderer).renderHands('0 0 1650 1650', '155.7', '308.5', '#0056A5', '#0056A5', '#0056A5', IEthereumWatchCoWatchHandsRenderer.HandType.ROUND);
