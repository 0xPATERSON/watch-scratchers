...
library WatchScratchersLibrary {
    ...
    */
    ...
    // Returns SVG of the "dress" watch hands, with a trailing space
    function _renderDressHands(
        ...
        svgParts[1] = string(abi.encodePacked(
