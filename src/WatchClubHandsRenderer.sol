...
contract WatchClubHandsRenderer is IWatchClubHandsRenderer {
    ...
    function renderHands(
        ...
        if (handType == HandType.DRESS_ROLEX) {
            ...
            svgParts[1] = '<g> <g class="hand hour-hand"> <line class="hand-outer" x1="50" x2="50" y1="25" y2="50"/> </g> <g class="hand minute-hand"> <line class="hand-outer" x1="50" x2="50" y1="17" y2="50"/> </g> <circle class="circle" cx="50" cy="50" r="5"/> </g> </svg> ';
