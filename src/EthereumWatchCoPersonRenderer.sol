...
contract EthereumWatchCoPersonRenderer is Ownable {
    ...
    string[8] private SHADOW_COLORS = ['#0049A0', '#AA0025', '#634698', '#2C2620', '#132841', '#008044', '#43484B', '#282528'];
    string [9] private BACKGROUND_COLORS = ['#FBF6E9', '#C4EAF2', '#E5E4EB', '#FDFDFD', '#8C7A66', '#FFEDE6', '#FFFBE3', '#B8C6A9', '#FAD5DC'];

    function _renderHat(HatType hatType) internal view returns (string memory) {
    ...
    function _renderGlasses(GlassesType glassesType) internal pure returns (string memory) {
        ...
        string memory aviatorPartOne = '<ellipse cx="114" cy="161.5" rx="39" ry="33.5" fill="';
        string memory aviatorPartTwo = '"/><ellipse cx="211" cy="161.5" rx="39" ry="33.5" fill="';
        string memory aviatorPartThree = '"/><path d="m79.745 151.83c5.038-15.889 24.059-20.184 32.94-20.346 8.914 0 18.893 1.292 22.768 1.938 13.951 1.55 17.439 10.98 17.439 15.501-0.775 8.913-2.261 15.663-2.906 17.923-3.488 14.727-16.632 23.575-22.768 26.159-13.176 5.425-26.804 2.261-31.972 0-19.764-6.976-18.569-30.357-15.501-41.175z" stroke="#000" stroke-width="10"/><path d="m245.93 151.35c-5.038-15.889-24.06-20.185-32.941-20.346-8.913 0-18.892 1.292-22.767 1.938-13.952 1.55-17.439 10.98-17.439 15.501 0.775 8.913 2.26 15.663 2.906 17.923 3.488 14.727 16.632 23.575 22.768 26.159 13.176 5.425 26.804 2.261 31.971 0 19.764-6.976 18.57-30.357 15.502-41.175z" stroke="#000" stroke-width="10"/><path d="m154.36 149.94c2.745-1.131 10.076-2.713 17.439 0" stroke="#000" stroke-width="10"/><line x1="122" x2="198" y1="132" y2="132" stroke="#000" stroke-width="10"/><line x1="250" x2="260" y1="156" y2="156" stroke="#000" stroke-linecap="round" stroke-width="10"/><line x1="72" x2="73" y1="156" y2="156" stroke="#000" stroke-linecap="round" stroke-width="10"/>';
    ...
    function _renderBodyAndBackground(
        ...
        return string(abi.encodePacked(
            ...
            SHIRT_COLORS[uint256(shirtType)], 
            partFour,
            SHADOW_COLORS[uint256(shirtType)],
            partFive
        ));
    }

    function _renderFace(MouthType mouthType, EarType earType) internal pure returns (string memory) {
        string memory mouth;
